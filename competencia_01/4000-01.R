...
PARAM$rpart$cp <- -1
PARAM$rpart$minsplit <- 771
PARAM$rpart$minbucket <- 375
...
setwd("C:/Users/47her/Documents/Maestria DM/EyF/Competencia1/buckets/b1/") # Establezco el Working Directory
...
# cargo el dataset
dataset <- fread("C:/Users/47her/Documents/Maestria DM/EyF/Competencia1/dataset_0.csv")
